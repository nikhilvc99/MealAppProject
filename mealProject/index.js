// create favourite meal array in local storage when its null
...
// show all meals card in main acording to search input value
function showMealList(){
    ...
    meals.then(data=>{
       //  if meal entered in search box is present than show the meal details else display for no records found
        if (data.meals) {
            data.meals.forEach((element) => {
                ...
                //if meal is already made as favorite the like button is active else its not active
                if (isFav) {
                    html += `
